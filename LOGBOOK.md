...
Visivelmente o modelo deu certo, mas calcular a acurácia tem sido um desafio, uma vez que o ground truth é um geotiff.
...
Ao aumenta a quantidade de dados, o modelo diminuiu o f1 score: com 140 atingiu o máximo de 0.36, mas subir para 200 caiu para 0.01. Acho que muito se deve pelo overfittilng do modelo, acabei inserindo muitos dados de fogo e ele entendeu que aquele é o normal. Quando ele atingiu o máximo, havia dados de todos os dias de 10 de abril a 16 de agosto Visualizando o ground truth que pedi no bdqueimadas, pude ver que os meses que mais possuem incêndios registrados são setembro e outubro. A soma de todos os registros do mês de setembro e outubro beira em 14 mil, já a soma de todos os outros meses não chega a 9 mil, sendo assim, refarei os testes com as mesmas variaveis mais excluindo todos os dados de setembro e outubro
